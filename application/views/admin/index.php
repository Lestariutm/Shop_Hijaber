        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <h1 style="margin-left: 10px; margin-top: -0px; color: white;">Shop_Hijaber</h1>
                </a>
            </div>
            <!-- end navbar-header -->
            <!-- navbar-top-links -->
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            <div class="user-info">
                                <div>Tela<strong>Handayani</strong></div>
                    ...
                    <li class="selected">
                     ...
                     <li>
                        <a href="<?php echo base_url().'index.php/Admin_kerudung'; ?>"><i class="fa fa-edit fa-fw"></i>Kerudung</a>
                    </li>
                     <li>
                        <a href="<?php echo base_url().'index.php/Admin_busana'; ?>"><i class="fa fa-edit fa-fw"></i>Busana Muslimah</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
